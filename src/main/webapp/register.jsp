...
<body class="container-fluid">
	...
	<form action="register" method="post" class="form card" id="frm">
		...
		<td>City</td>
		<td><select name="city">
		    <option value="pune">Kathmandu</option>
		    <option value="Mumbai">Pokhara</option>
		    <option value="Delhi">Lumbini</option>
		    <option value="Hydrabad">Dhading</option>
		</select></td>
		</tr>
		<tr>
		<td>Gender</td>
